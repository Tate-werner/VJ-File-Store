...
PICS = (environ.get('PICS', 'https://envs.sh/E-6.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5560200410 6754286457').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "TatefilestoreBot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://wernertatetg:mXlhCrhJScUl4LW2@cluster0.64ekp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1001996102120"))
